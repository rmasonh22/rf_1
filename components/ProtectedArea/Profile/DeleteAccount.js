  ...
  return (
    <div>
      <div className="mt-10 sm:mt-0">
                  ...
                  <form onSubmit={handleAccountDeletion}>
                    ...
                    <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                      {user?.email ? ( // if the user is not anonymous, we show the button to change the password
                        ...
                        <div className="focus:ring-lightning-500 inline-flex w-full justify-center rounded-md border border-transparent bg-gray-300 py-2 px-4 text-center text-sm font-medium text-gray-700 shadow-sm focus:outline-none focus:ring-2  focus:ring-offset-2 sm:ml-8 sm:w-auto sm:text-sm">
                      ...
                      <button
                        type="button"
                        className="focus:ring-lightning-500 mt-3 inline-flex w-full items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
        ...
        >
          <ExclamationIcon className="mr-3 h-5 w-5" />
          Delete your account
        </button>
      </div>
    </div>
